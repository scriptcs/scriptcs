    ...
    public class RoslynScriptEngineTests
    {
        ...
        public class TheExecuteMethod 
        {
            ...
            public void ShouldCreateScriptHostWithContexts()
            {
                ...
                engine.Execute("script.csx", Enumerable.Empty<string>(), new List<IScriptPack> { scriptPack.Object });
            ...
            public void ShouldTerminateScriptPacksWhenScriptFinishes()
            {
                ...
                engine.Execute("script.csx", Enumerable.Empty<string>(), new List<IScriptPack> { scriptPack1.Object });
