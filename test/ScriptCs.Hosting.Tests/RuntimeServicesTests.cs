    ...
    public class RuntimeServicesTests
    {
        public class TheCreateContainerMethod
        {
            ...
            public void ShouldLogOnDebugAnAssemblyLoadFailure()
            {
                ...
                _overrides[typeof (IAssemblyResolver)] = mock.Object;
                var initializationServices = new InitializationServices(_mockLogger.Object, _overrides);
                var runtimeServices = new RuntimeServices(_mockLogger.Object, _overrides, new List<Type>(), new List<Type>(), _mockConsole.Object, _scriptEngineType, _scriptExecutorType, true, initializationServices, "script.csx");
            ...
            public void ShouldLogAGeneralWarningOnAnAssemblyLoadFailureWhenRunningInRepl()
            {
                ...
                _overrides[typeof(IAssemblyResolver)] = mock.Object;
                var initializationServices = new InitializationServices(_mockLogger.Object, _overrides);
                var runtimeServices = new RuntimeServices(_mockLogger.Object, _overrides, new List<Type>(), new List<Type>(), _mockConsole.Object, _scriptEngineType, _scriptExecutorType, true, initializationServices, "");
                var container = runtimeServices.Container;
            ...
            public void ShouldResolveAssembliesBasedOnScriptWorkignDirectory()
            {
                ...
                var initializationServices = new InitializationServices(_mockLogger.Object, _overrides);
                var runtimeServices = new RuntimeServices(_mockLogger.Object, _overrides, new List<Type>(), new List<Type>(), _mockConsole.Object, _scriptEngineType, _scriptExecutorType, true, initializationServices, "c:/scriptcs/script.csx");
                var container = runtimeServices.Container;
