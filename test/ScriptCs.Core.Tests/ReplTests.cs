    ...
    public class ReplTests
    {
        public class Mocks
        {
            public Mocks()
            {
                ...
                CompilationExceptionWriter = new Mock<ICompilationExceptionWriter>();
            }
            ...
            public Mock<ICompilationExceptionWriter> CompilationExceptionWriter { get; private set; }
        }

        public static Repl GetRepl(Mocks mocks)
        {
            return new Repl(new string[0], mocks.FileSystem.Object, mocks.ScriptEngine.Object, mocks.Logger.Object, mocks.Console.Object, mocks.FilePreProcessor.Object, mocks.CompilationExceptionWriter.Object);
        }
