...
namespace ScriptCs.Tests
{
    public class PackageAssemblyResolverTests
    {
        public class GetAssemblyNamesMethod
        {
            ...
            {
                var resolver = new PackageAssemblyResolver(_filesystem.Object, _packageContainer.Object, _log, _assemblyUtility.Object);
            ...
            public void WhenNoPackagesAreFoundShouldLogWarning()
            {
                ...
                // assert
                _log.Output.ShouldContain("WARN: Cannot find: testId 3.0");
            }
            ...
            {
                var resolver = new PackageAssemblyResolver(_filesystem.Object, new Mock<IPackageContainer>().Object, _log, _assemblyUtility.Object);
        ...
        public class GetPackagesMethod
        {
            ...
            public void ShouldReturnEmptyIfPackagesConfigDoesNotExist()
            {
                ...
                var resolver = new PackageAssemblyResolver(_fs.Object, _pc.Object, _logger.Object, _assemblyUtility.Object);
        ...
        public class SavePackagesMethod
        {
            ...
            {
                return new PackageAssemblyResolver(_fs.Object, _pc.Object, _log, _assemblyUtility.Object);
            }
