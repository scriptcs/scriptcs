...
namespace ScriptCs.Core.Tests
{
    public class PackageAssemblyResolverTests
    {
        ...
        public PackageAssemblyResolverTests()
        {
            ...
            _package.Setup(i => i.GetCompatibleDlls(It.IsAny<FrameworkName>())).Returns(new List<string> { "test.dll", "test2.dll" });
            ...
            _packageIds = new List<IPackageReference> { new PackageReference("testId", VersionUtility.ParseFrameworkName("net40")) };
        ...
        {
            _package.Setup(i => i.GetCompatibleDlls(It.Is<FrameworkName>(x => x.FullName == VersionUtility.ParseFrameworkName("net40").FullName))).Returns(new List<string> { "test.dll" });
        ...
        {
            _packageContainer.Setup(i => i.FindPackage(It.IsAny<string>(), It.IsAny<string>())).Returns<List<IPackageObject>>(null);
