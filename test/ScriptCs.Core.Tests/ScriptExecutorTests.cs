    ...
    public class ScriptExecutorTests
    {
        ...
        public class TheExecuteMethod
        {
            ...
            public void ConstructsAbsolutePathBeforePreProcessingFile()
            {
                ...
                executor.Execute("script.csx", new string[0], Enumerable.Empty<string>(), Enumerable.Empty<IScriptPack>());
            ...
            public void DoNotChangePathIfAbsolute()
            {
                ...
                var executor = CreateScriptExecutor(fileSystem: fileSystem, fileProcessor: preProcessor);
                executor.Execute(@"c:\my_script\script.csx", new string[0], Enumerable.Empty<string>(), Enumerable.Empty<IScriptPack>());
            ...
            public void ShouldSetEngineBaseDirectoryBasedOnCurrentDirectoryAndBinFolder()
            {
                ...
                // act
                scriptExecutor.Execute(scriptName, new string[0], paths, recipes);
            ...
            public void ShouldAddReferenceToEachDestinationFile()
            {
                ...
                // act
                scriptExecutor.Execute(scriptName, new string[0], paths, Enumerable.Empty<IScriptPack>());
            ...
            public void ShouldInitializeScriptPacks()
            {
                ...
                executor.Execute("script.csx", new string[0], Enumerable.Empty<string>(), new[] { scriptPack1.Object });
